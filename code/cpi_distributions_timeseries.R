...
clean_data <- function(df) {
  ...
  # filter 2 months before contract expiry
  df <- df %>%
    filter(
      date >= expiry_date - months(2),
    ) %>%
    arrange(contract_preamble, strike, date)
...
# animate_distribution_mov(df, contract = "KXCPIYOY-25FEB", start_date = "2024-06-14", end_date = "2025-03-28", output_file = "output/evolution_movs/cpi/Feb25_pdf.mov", col_to_graph = 'pdf')
# 
# animate_distribution_mov(df, contract = "KXCPIYOY-25MAR", start_date = "2024-06-14", end_date = "2025-04-28", output_file = "output/evolution_movs/cpi/Mar25_cdf.mov")
# animate_distribution_mov(df, contract = "KXCPIYOY-25MAR", start_date = "2024-06-14", end_date = "2025-04-28", output_file = "output/evolution_movs/cpi/Mar25_pdf.mov", col_to_graph = 'pdf')
# 
# animate_distribution_mov(df, contract = "KXCPIYOY-25APR", start_date = "2024-06-14", end_date = "2025-05-28", output_file = "output/evolution_movs/cpi/Apr25_cdf.mov")
# animate_distribution_mov(df, contract = "KXCPIYOY-25APR", start_date = "2024-06-14", end_date = "2025-05-28", output_file = "output/evolution_movs/cpi/Apr25_pdf.mov", col_to_graph = 'pdf')
# 
# 
# 
